 ...
 * @version 1.0
 */
public class I1AlarmSend {
    /**
     * log
     */
    private static Log log = LogFactory.getLog(I1AlarmSend.class);
    private static I1AlarmSend NorhAlarmSend = new I1AlarmSend();
    ...
    private void initialize() {
        ...
        table_param.setBounds(0, 78, 251, 150);
        ...
        table_param.setModel(new DefaultTableModel(
                new Object[][]{{"port", Propert.getPropert().getI1_alarm_port()},
                        {"User", Propert.getPropert().getI1_alarm_user()},
                        {"Password", Propert.getPropert().getI1_alarm_pwd()},
                        {"charset", Propert.getPropert().getCharset()},
                        {"heartInterval", Propert.getPropert().getI1_heart_interval()},
                        {null, null},},
     ...
     */
    public static I1AlarmSend initInterfacePage() {
    ...
    public void getInterfacePage() {
        table_param.setModel(new DefaultTableModel(
                new Object[][]{{"port", Propert.getPropert().getI1_alarm_port()},
                        ...
                        {"Password", Propert.getPropert().getI1_alarm_pwd()},
                        {"charset", Propert.getPropert().getCharset()},
                        {"heartInterval", Propert.getPropert().getI1_heart_interval()}, {null, null},},
                new String[]{"New column", "New column"}));
        InfoSend.getContentPane().add(table_param);
        editorPane_info.setText(Propert.getPropert().getMsg());
        InfoSend.getContentPane().add(editorPane_info);
