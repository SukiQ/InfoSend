...
public class TelnetSend {
    ...
    private void initialize() {
        ...
        table_param.setBounds(0, 61, 251, 181);
        ...
        table_param.setModel(new DefaultTableModel(
                new Object[][]{
                        {"ftpUser", Propert.getPropert().getTelnetFtpuser()},
                        {"ftpPassword", Propert.getPropert().getTelnetFtppassword()},
                        {"ftpSource", Propert.getPropert().getTelnetFtpSource()},
                        {"ftpSIp", Propert.getPropert().getTelnetFtpIp()},
                        {"fileType", Propert.getPropert().getTelnetFileType()},
        ...
        editorPane_info.setBounds(0, 265, 251, 212);
        ...
        btnSend.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    /* 设置报错弹窗 */
                    log.error("socket_client接口初始化发送异常", t);
    ...
    /**
     * 获取SocketClientSend对象
     *
     * @return SocketClientSend对象
     */
    public static TelnetSend initInterfacePage() {
        return socketclientsend;
    }

    /**
     * 打开SocketClientSend界面，每次获取时，更新参数表显示
     */
