...
public class ActiveMQSend {
    ...
    private static ActiveMQSend activemqsend = new ActiveMQSend();
    ...
    private void initialize() {
        ...
        table_param.setModel(new DefaultTableModel(
                new Object[][]{{"url", Propert.getPropert().getActmqurl()},
                        {"qname", Propert.getPropert().getActmqname()},
                        {"username", Propert.getPropert().getActmquser()},
                        {"password", Propert.getPropert().getActmqpwd()},
        ...
        btnSend.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    /* 设置报错弹窗 */
                    log.error("ActiveMQPage接口初始化发送异常", t);
     ...
     */
    public static ActiveMQSend initInterfacePage() {
        return activemqsend;
    }
