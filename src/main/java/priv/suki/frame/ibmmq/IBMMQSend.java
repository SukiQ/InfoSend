...
public class IBMMQSend {
    ...
    private static IBMMQSend activemqsend = new IBMMQSend();
    ...
    private void initialize() {
        ...
        table_param.setBounds(0, 63, 251, 210);
        table_param.setFont(new Font("微软雅黑 Light", Font.PLAIN, 13));
        ...
        table_param.setModel(new DefaultTableModel(
                new Object[][]{{"ip", Propert.getPropert().getIbmmqIp()},
                        {"port", Propert.getPropert().getIbmPort()},
                        {"QueueManage", Propert.getPropert().getIbmmqQueueManager()},
                        {"QueueName", Propert.getPropert().getIbmmqQueueName()},
                        {"Channel", Propert.getPropert().getIbmmqChannel()},
                        {"ccsid", Propert.getPropert().getIbmmq_CCSID()},
        ...
        editorPane_info.setBounds(0, 286, 251, 191);
        ...
        btnSend.addActionListener(e -> {
            ...
            try {
                ...
                /* 设置报错弹窗 */
                log.error("IBMMQPage接口初始化发送异常", t);
     ...
     * 获取ActiveMQSend对象
     *
     * @return ActiveMQSend对象
     */
    public static IBMMQSend initInterfacePage() {
        return activemqsend;
    }

    /**
     * 打开ActiveMQSend界面，每次获取时，更新参数表显示
     */
