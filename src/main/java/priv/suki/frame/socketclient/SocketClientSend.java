...
public class SocketClientSend {
    // Log
    private static Log log = LogFactory.getLog(SocketClientSend.class);
    //	private static Logger logger = Logger.getLogger("Log4jMain");
    private static SocketClientSend socketclientsend = new SocketClientSend();
    ...
    private void initialize() {
        ...
        table_param.setModel(new DefaultTableModel(
                new Object[][]{{"ip", Propert.getPropert().getSocket_client_ip()},
                        {"port", Propert.getPropert().getSocket_client_port()},
     ...
     */
    public static SocketClientSend initInterfacePage() {
