 ...
 * @version 1.0
 */
public class GNDPReadPage {
    // Log
    private static Log log = LogFactory.getLog(GNDPReadPage.class);
    private static GNDPReadPage socketServerReadPage = new GNDPReadPage();
     ...
     */
    public static GNDPReadPage initInterfacePage() {
