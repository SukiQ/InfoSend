 ...
 * @version 1.0
 */
public class GNDPSend {
    // Log
    private static Log log = LogFactory.getLog(GNDPSend.class);
    //	private static Logger logger = Logger.getLogger("Log4jMain");
    private static GNDPSend SocketServerSend = new GNDPSend();
     ...
     */
    public static GNDPSend initInterfacePage() {
