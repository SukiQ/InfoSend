 ...
 * @version 1.0.4
 */
public class CUCCAlarmSend {
    /**
     * log
     */
    private static Log log = LogFactory.getLog(CUCCAlarmSend.class);
    private static CUCCAlarmSend CUCCAlarmSend = new CUCCAlarmSend();
    ...
    private void initialize() {
        ...
        table_param.setModel(new DefaultTableModel(
                new Object[][]{{"port", Propert.getPropert().getCucc_alarm_port()},
                        {"User", Propert.getPropert().getCucc_alarm_user()},
                        {"Password", Propert.getPropert().getCucc_alarm_pwd()},
     ...
     */
    public static CUCCAlarmSend initInterfacePage() {
        return CUCCAlarmSend;
    }
