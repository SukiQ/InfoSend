 ...
 * @version 1.0
 */
public class SNMPSend {
    // Log
    private static Log log = LogFactory.getLog(SNMPSend.class);
    //	private static Logger logger = Logger.getLogger("Log4jMain");
    private static SNMPSend SNMP = new SNMPSend();
    ...
    private void initialize() {
        ...
        table_param.setBounds(0, 92, 251, 150);
        ...
        table_param.setModel(new DefaultTableModel(
                new Object[][]{{"version", Propert.getPropert().getSnmp_version()},
                        {"port", Propert.getPropert().getSnmp_port()}, {"ip", Propert.getPropert().getSnmp_ip()},
                        {"trap_oid", Propert.getPropert().getSnmp_trapOid()},
        ...
        List<SNMPBindVar> snmpMsg = Propert.getPropert().getSnmpMsg();
        ...
        editorPane_info.setText(msgBuilder.toString());
        ...
        checkBox_build.setBounds(60, 280, 165, 44);
     ...
     * @return SNMP对象
     */
    public static SNMPSend initInterfacePage() {
        return SNMP;
    }

    /**
     * 打开SNMP界面，每次获取时，更新参数表显示
     */
